...
export default function Navbar() {
  return (
    <nav className="bg-slate-600 p8 sticky top-0 drop-shadow-xl z-10">
      <div className="md:px-6 prose prose-xl mx-auto flex justify-between flex-col sm:flex-row">
        <h1 className="text-3xl font-bold text-white grid place-content-center mb-2 md:mb-0">
          <Link
            href="/"
            className="dark:text-white/90 no-underline hover:text-white"
          >
            Bart Van Hoey
          </Link>
        </h1>
        <div className="flex pb-4 justify-center sm:justify-evenly align-middle gap-4 text-white text-4xl lg:text-5xl">
          <Link
